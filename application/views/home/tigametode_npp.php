<?php if (!isset($_GET['tanggal']) || !isset($_GET['npp'])) { ?>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="mt-5">
                <a href="<?= base_url('tigametode/hasilmanual'); ?>">Hasil Perbandingan Pengukuran Jarak Manual</a>
            </div>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="mt-3">
                <div class="d-flex">
                    <div class="mr-auto ml-auto">
                        <a href="<?= base_url('tigametode/hitung/') ?><?= $tanggal . '/' ?><?= $npp ?>" target="_blank" class="btn btn-info">Hitung Jarak</a>
                    </div>
                </div>
            </div>
            <div class="mt-1">
                <div class="d-flex">
                    <div class="mr-auto ml-auto">
                        <a href="<?= base_url('tigametode/excel/') ?><?= $tanggal . '/' ?><?= $npp ?>" target="_blank">Download File Excel</a>
                    </div>
                </div>
            </div>
