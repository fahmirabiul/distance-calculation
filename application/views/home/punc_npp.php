    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="mt-3">
                <div class="d-flex">
                    <div class="mr-auto ml-auto">
                        <a href="<?= base_url('punctuality/eksekusi/') ?><?= $tanggal . '/' ?><?= $npp ?>" target="_blank" class="btn btn-info">Hitung Ketepatan Waktu</a>
                    </div>
                </div>
            </div>
            <div class="mt-1">
                <div class="d-flex">
                    <div class="mr-auto ml-auto">
                        <a href="<?= base_url('punctuality/excel/') ?><?= $tanggal . '/' ?><?= $npp ?>" target="_blank">Download File Excel</a>
                    </div>
                </div>
            </div>
        </div>
